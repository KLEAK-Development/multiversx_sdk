...
import 'package:elrond_sdk/src/models/request/transaction/cost/cost.dart';
...
abstract class TransactionRepository {
  ...
  Future<SendMultipleTransactionResponse> sendMultiple(@Body() List<SendTransactionRequest> request);
