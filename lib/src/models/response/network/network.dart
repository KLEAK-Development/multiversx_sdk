...
abstract class NetworkConfigurationInformationsData with _$NetworkConfigurationInformationsData {
  factory NetworkConfigurationInformationsData({
    @JsonKey(name: 'erd_chain_id') String chainId,
    ...
    @JsonKey(name: 'erd_min_gas_limit') int minGasLimit,
    @JsonKey(name: 'erd_min_gas_price') int minGasPrice,
    @JsonKey(name: 'erd_min_transaction_version') int minTransactionVersion,
